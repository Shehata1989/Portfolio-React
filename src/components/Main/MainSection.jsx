  ...
  return (
    <section className="flex gap-24 text-[var(--text-color)] mt-8">
      <div className="btn flex flex-col gap-5">
        {button.map((link, idx) => (
          <button
            className={`bg-[var(--menu-bg)] rounded-md px-4 py-2 border border-transparent hover:border-[var(--hover-icon)] transition-all duration-300 opacity-50 hover:opacity-100 ${
